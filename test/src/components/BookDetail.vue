		...
		<div class="detail-content" v-if="bookDetail">
			<div class="detail-linear">
				<header class="detail-top">
					<a @click="detail-title"><i class="back"></i>
				...
				<div class="detail-con" v-if="!loading">
					...
					<div class="detail-main">
						...
						<p class="type">分类:{{ bookDetail.author }}</p>
						<p class="word-count">{{ bookDetail.author }}万字</p>
			...
			<div v-if="!loading">
				<div class="detail-intro">
					<p :class="{show5:!showmore}" @click="showmore">{{bookDetail.intro}}</p>
				</div>
	...
	export default {
		...
		methods:{
			...
			getBookDetail(bookId){
				this.loading = true
				axios.get(`${this.common.api}/books/${bookId}`+'/').then(res=>{
					this.loading = false
					this.showmore = false
					this.bookDetail = res.data
					this.like = res.data.like.split('-')
				})
			},
			openBook(){
